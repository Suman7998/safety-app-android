...
public final class DialogAddContactBinding implements ViewBinding {
  ...
  private DialogAddContactBinding(@NonNull LinearLayout rootView,
      @NonNull TextInputEditText nameInput, @NonNull TextInputEditText phoneInput,
      @NonNull TextInputEditText relationshipInput) {
  ...
  public static DialogAddContactBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogAddContactBinding((LinearLayout) rootView, nameInput, phoneInput,
          relationshipInput);
    }
